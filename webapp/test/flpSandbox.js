		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight List &amp; Overview",
									"targetURL": "#hogentcomflightoverview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hogentcomflightoverview-display": {
								"semanticObject": "hogentcomflightoverview",
								"action": "display",
								"description": "A detailed overview of availlable flights",
								"title": "Flight List &amp; Overview",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hogent.com.flightoverview",
									"url": sap.ui.require.toUrl("hogent/com/flightoverview")
								}
							}
						}
					}
